...
namespace FileManager.DAL.Migrations
{
    ...
    [Migration("20240501144842_ChangeTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.Course", b =>
                {
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseItem", b =>
                {
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseItemProgressType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseItemType", b =>
                {
                    b.Property<int>("CourseItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseItemUserProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseUserProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseItem", b =>
                {
                    b.HasOne("FileManager.DAL.Domain.DataSet.DataSet", "AttachedDataSet")
                        .WithMany()
                        .HasForeignKey("AttachedDataSetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("FileManager.DAL.Domain.PianoMentor.Courses.Course", "Course")
            ...
            modelBuilder.Entity("FileManager.DAL.Domain.PianoMentor.Courses.CourseItemUserProgress", b =>
                {
                    b.HasOne("FileManager.DAL.Domain.PianoMentor.Courses.CourseItem", "CourseItem")
                        .WithMany()
                        .HasForeignKey("CourseItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FileManager.DAL.Domain.PianoMentor.Courses.CourseItemProgressType", "CourseItemProgressType")
                        .WithMany()
