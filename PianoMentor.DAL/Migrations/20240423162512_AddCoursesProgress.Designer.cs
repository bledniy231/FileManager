...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.Course", b =>
                {
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseItem", b =>
                {
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseItemProgressType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseItemUserProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseType", b =>
                {
                    b.Property<int>("CourseTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CourseTypes", "PianoMentor");
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseUserProgress", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseItem", b =>
                {
                    b.HasOne("PianoMentor.DAL.Domain.PianoMentor.Course", "Course")
                        .WithMany("CourseItems")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PianoMentor.DAL.Domain.PianoMentor.CourseType", "CourseType")
                        .WithMany()
            ...
            modelBuilder.Entity("PianoMentor.DAL.Domain.PianoMentor.CourseItemUserProgress", b =>
                {
                    b.HasOne("PianoMentor.DAL.Domain.PianoMentor.CourseItem", "CourseItem")
                        .WithMany()
                        .HasForeignKey("CourseItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PianoMentor.DAL.Domain.PianoMentor.CourseItemProgressType", "CourseItemProgressType")
                        .WithMany()
